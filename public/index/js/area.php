...
$area_array=[];
				...
				$sub_array[82][8207]="圣方济各堂区";$l_arr=[];
				$sub_arr=[];$l_arr[1301]="石家庄市";
				$sub_arr[1301]=[];
				$sub_arr[1301][0]="请选择";
				...
				$sub_arr[1301][130185]="鹿泉市";$l_arr[1302]="唐山市";
				$sub_arr[1302]=[];
				$sub_arr[1302][0]="请选择";
				...
				$sub_arr[1302][130283]="迁安市";$l_arr[1303]="秦皇岛市";
				$sub_arr[1303]=[];
				$sub_arr[1303][0]="请选择";
				...
				$sub_arr[1303][130324]="卢龙县";$l_arr[1304]="邯郸市";
				$sub_arr[1304]=[];
				$sub_arr[1304][0]="请选择";
				...
				$sub_arr[1304][130481]="武安市";$l_arr[1305]="邢台市";
				$sub_arr[1305]=[];
				$sub_arr[1305][0]="请选择";
				...
				$sub_arr[1305][130582]="沙河市";$l_arr[1306]="保定市";
				$sub_arr[1306]=[];
				$sub_arr[1306][0]="请选择";
				...
				$sub_arr[1306][130684]="高碑店市";$l_arr[1307]="张家口市";
				$sub_arr[1307]=[];
				$sub_arr[1307][0]="请选择";
				...
				$sub_arr[1307][130733]="崇礼县";$l_arr[1308]="承德市";
				$sub_arr[1308]=[];
				$sub_arr[1308][0]="请选择";
				...
				$sub_arr[1308][130828]="围场县";$l_arr[1309]="沧州市";
				$sub_arr[1309]=[];
				$sub_arr[1309][0]="请选择";
				...
				$sub_arr[1309][130984]="河间市";$l_arr[1310]="廊坊市";
				$sub_arr[1310]=[];
				$sub_arr[1310][0]="请选择";
				...
				$sub_arr[1310][131082]="三河市";$l_arr[1311]="衡水市";
				$sub_arr[1311]=[];
				$sub_arr[1311][0]="请选择";
				...
				$sub_arr[1311][131182]="深州市";$l_arr[1401]="太原市";
				$sub_arr[1401]=[];
				$sub_arr[1401][0]="请选择";
				...
				$sub_arr[1401][140181]="古交市";$l_arr[1402]="大同市";
				$sub_arr[1402]=[];
				$sub_arr[1402][0]="请选择";
				...
				$sub_arr[1402][140227]="大同县";$l_arr[1403]="阳泉市";
				$sub_arr[1403]=[];
				$sub_arr[1403][0]="请选择";
				...
				$sub_arr[1403][140322]="盂县";$l_arr[1404]="长治市";
				$sub_arr[1404]=[];
				$sub_arr[1404][0]="请选择";
				...
				$sub_arr[1404][140481]="潞城市";$l_arr[1405]="晋城市";
				$sub_arr[1405]=[];
				$sub_arr[1405][0]="请选择";
				...
				$sub_arr[1405][140581]="高平市";$l_arr[1406]="朔州市";
				$sub_arr[1406]=[];
				$sub_arr[1406][0]="请选择";
				...
				$sub_arr[1406][140624]="怀仁县";$l_arr[1407]="晋中市";
				$sub_arr[1407]=[];
				$sub_arr[1407][0]="请选择";
				...
				$sub_arr[1407][140781]="介休市";$l_arr[1408]="运城市";
				$sub_arr[1408]=[];
				$sub_arr[1408][0]="请选择";
				...
				$sub_arr[1408][140882]="河津市";$l_arr[1409]="忻州市";
				$sub_arr[1409]=[];
				$sub_arr[1409][0]="请选择";
				...
				$sub_arr[1409][140981]="原平市";$l_arr[1410]="临汾市";
				$sub_arr[1410]=[];
				$sub_arr[1410][0]="请选择";
				...
				$sub_arr[1410][141082]="霍州市";$l_arr[1411]="吕梁市";
				$sub_arr[1411]=[];
				$sub_arr[1411][0]="请选择";
				...
				$sub_arr[1411][141182]="汾阳市";$l_arr[1501]="呼和浩特市";
				$sub_arr[1501]=[];
				$sub_arr[1501][0]="请选择";
				...
				$sub_arr[1501][150125]="武川县";$l_arr[1502]="包头市";
				$sub_arr[1502]=[];
				$sub_arr[1502][0]="请选择";
				...
				$sub_arr[1502][150223]="达尔罕茂明安联合旗";$l_arr[1503]="乌海市";
				$sub_arr[1503]=[];
				$sub_arr[1503][0]="请选择";
				$sub_arr[1503][150302]="海勃湾区";
				$sub_arr[1503][150303]="海南区";
				$sub_arr[1503][150304]="乌达区";$l_arr[1504]="赤峰市";
				$sub_arr[1504]=[];
				$sub_arr[1504][0]="请选择";
				...
				$sub_arr[1504][150430]="敖汉旗";$l_arr[1505]="通辽市";
				$sub_arr[1505]=[];
				$sub_arr[1505][0]="请选择";
				...
				$sub_arr[1505][150581]="霍林郭勒市";$l_arr[1506]="鄂尔多斯市";
				$sub_arr[1506]=[];
				$sub_arr[1506][0]="请选择";
				...
				$sub_arr[1506][150627]="伊金霍洛旗";$l_arr[1507]="呼伦贝尔市";
				$sub_arr[1507]=[];
				$sub_arr[1507][0]="请选择";
				...
				$sub_arr[1507][150785]="根河市";$l_arr[1508]="巴彦淖尔市";
				$sub_arr[1508]=[];
				$sub_arr[1508][0]="请选择";
				...
				$sub_arr[1508][150826]="杭锦后旗";$l_arr[1509]="乌兰察布市";
				$sub_arr[1509]=[];
				$sub_arr[1509][0]="请选择";
				...
				$sub_arr[1509][150981]="丰镇市";$l_arr[1522]="兴安盟";
				$sub_arr[1522]=[];
				$sub_arr[1522][0]="请选择";
				...
				$sub_arr[1522][152224]="突泉县";$l_arr[1525]="锡林郭勒盟";
				$sub_arr[1525]=[];
				$sub_arr[1525][0]="请选择";
				...
				$sub_arr[1525][152531]="多伦县";$l_arr[1529]="阿拉善盟";
				$sub_arr[1529]=[];
				$sub_arr[1529][0]="请选择";
				$sub_arr[1529][152921]="阿拉善左旗";
				$sub_arr[1529][152922]="阿拉善右旗";
				$sub_arr[1529][152923]="额济纳旗";$l_arr[2101]="沈阳市";
				$sub_arr[2101]=[];
				$sub_arr[2101][0]="请选择";
				...
				$sub_arr[2101][210181]="新民市";$l_arr[2102]="大连市";
				$sub_arr[2102]=[];
				$sub_arr[2102][0]="请选择";
				...
				$sub_arr[2102][210283]="庄河市";$l_arr[2103]="鞍山市";
				$sub_arr[2103]=[];
				$sub_arr[2103][0]="请选择";
				...
				$sub_arr[2103][210381]="海城市";$l_arr[2104]="抚顺市";
				$sub_arr[2104]=[];
				$sub_arr[2104][0]="请选择";
				...
				$sub_arr[2104][210423]="清原县";$l_arr[2105]="本溪市";
				$sub_arr[2105]=[];
				$sub_arr[2105][0]="请选择";
				...
				$sub_arr[2105][210522]="桓仁县";$l_arr[2106]="丹东市";
				$sub_arr[2106]=[];
				$sub_arr[2106][0]="请选择";
				...
				$sub_arr[2106][210682]="凤城市";$l_arr[2107]="锦州市";
				$sub_arr[2107]=[];
				$sub_arr[2107][0]="请选择";
				...
				$sub_arr[2107][210782]="北镇市";$l_arr[2108]="营口市";
				$sub_arr[2108]=[];
				$sub_arr[2108][0]="请选择";
				...
				$sub_arr[2108][210882]="大石桥市";$l_arr[2109]="阜新市";
				$sub_arr[2109]=[];
				$sub_arr[2109][0]="请选择";
				...
				$sub_arr[2109][210922]="彰武县";$l_arr[2110]="辽阳市";
				$sub_arr[2110]=[];
				$sub_arr[2110][0]="请选择";
				...
				$sub_arr[2110][211081]="灯塔市";$l_arr[2111]="盘锦市";
				$sub_arr[2111]=[];
				$sub_arr[2111][0]="请选择";
				$sub_arr[2111][211102]="双台子区";
				$sub_arr[2111][211103]="兴隆台区";
				$sub_arr[2111][211121]="大洼县";
				$sub_arr[2111][211122]="盘山县";$l_arr[2112]="铁岭市";
				$sub_arr[2112]=[];
				$sub_arr[2112][0]="请选择";
				...
				$sub_arr[2112][211282]="开原市";$l_arr[2113]="朝阳市";
				$sub_arr[2113]=[];
				$sub_arr[2113][0]="请选择";
				...
				$sub_arr[2113][211382]="凌源市";$l_arr[2114]="葫芦岛市";
				$sub_arr[2114]=[];
				$sub_arr[2114][0]="请选择";
				...
				$sub_arr[2114][211491]="杨家杖子开发区";$l_arr[2201]="长春市";
				$sub_arr[2201]=[];
				$sub_arr[2201][0]="请选择";
				...
				$sub_arr[2201][220183]="德惠市";$l_arr[2202]="吉林市";
				$sub_arr[2202]=[];
				$sub_arr[2202][0]="请选择";
				...
				$sub_arr[2202][220284]="磐石市";$l_arr[2203]="四平市";
				$sub_arr[2203]=[];
				$sub_arr[2203][0]="请选择";
				...
				$sub_arr[2203][220382]="双辽市";$l_arr[2204]="辽源市";
				$sub_arr[2204]=[];
				$sub_arr[2204][0]="请选择";
				$sub_arr[2204][220402]="龙山区";
				$sub_arr[2204][220403]="西安区";
				$sub_arr[2204][220421]="东丰县";
				$sub_arr[2204][220422]="东辽县";$l_arr[2205]="通化市";
				$sub_arr[2205]=[];
				$sub_arr[2205][0]="请选择";
				...
				$sub_arr[2205][220582]="集安市";$l_arr[2206]="白山市";
				$sub_arr[2206]=[];
				$sub_arr[2206][0]="请选择";
				...
				$sub_arr[2206][220681]="临江市";$l_arr[2207]="松原市";
				$sub_arr[2207]=[];
				$sub_arr[2207][0]="请选择";
				...
				$sub_arr[2207][220724]="扶余县";$l_arr[2208]="白城市";
				$sub_arr[2208]=[];
				$sub_arr[2208][0]="请选择";
				...
				$sub_arr[2208][220882]="大安市";$l_arr[2224]="延边州";
				$sub_arr[2224]=[];
				$sub_arr[2224][0]="请选择";
				...
				$sub_arr[2224][222426]="安图县";$l_arr[2301]="哈尔滨市";
				$sub_arr[2301]=[];
				$sub_arr[2301][0]="请选择";
				...
				$sub_arr[2301][230184]="五常市";$l_arr[2302]="齐齐哈尔市";
				$sub_arr[2302]=[];
				$sub_arr[2302][0]="请选择";
				...
				$sub_arr[2302][230281]="讷河市";$l_arr[2303]="鸡西市";
				$sub_arr[2303]=[];
				$sub_arr[2303][0]="请选择";
				...
				$sub_arr[2303][230382]="密山市";$l_arr[2304]="鹤岗市";
				$sub_arr[2304]=[];
				$sub_arr[2304][0]="请选择";
				...
				$sub_arr[2304][230422]="绥滨县";$l_arr[2305]="双鸭山市";
				$sub_arr[2305]=[];
				$sub_arr[2305][0]="请选择";
				...
				$sub_arr[2305][230524]="饶河县";$l_arr[2306]="大庆市";
				$sub_arr[2306]=[];
				$sub_arr[2306][0]="请选择";
				...
				$sub_arr[2306][230624]="杜尔伯特";$l_arr[2307]="伊春市";
				$sub_arr[2307]=[];
				$sub_arr[2307][0]="请选择";
				...
				$sub_arr[2307][230781]="铁力市";$l_arr[2308]="佳木斯市";
				$sub_arr[2308]=[];
				$sub_arr[2308][0]="请选择";
				...
				$sub_arr[2308][230882]="富锦市";$l_arr[2309]="七台河市";
				$sub_arr[2309]=[];
				$sub_arr[2309][0]="请选择";
				$sub_arr[2309][230902]="新兴区";
				$sub_arr[2309][230903]="桃山区";
				$sub_arr[2309][230904]="茄子河区";
				$sub_arr[2309][230921]="勃利县";$l_arr[2310]="牡丹江市";
				$sub_arr[2310]=[];
				$sub_arr[2310][0]="请选择";
				...
				$sub_arr[2310][231085]="穆棱市";$l_arr[2311]="黑河市";
				$sub_arr[2311]=[];
				$sub_arr[2311][0]="请选择";
				...
				$sub_arr[2311][231182]="五大连池市";$l_arr[2312]="绥化市";
				$sub_arr[2312]=[];
				$sub_arr[2312][0]="请选择";
				...
				$sub_arr[2312][231283]="海伦市";$l_arr[2327]="大兴安岭地区";
				$sub_arr[2327]=[];
				$sub_arr[2327][0]="请选择";
				...
				$sub_arr[2327][232723]="漠河县";$l_arr[3201]="南京市";
				$sub_arr[3201]=[];
				$sub_arr[3201][0]="请选择";
				...
				$sub_arr[3201][320125]="高淳县";$l_arr[3202]="无锡市";
				$sub_arr[3202]=[];
				$sub_arr[3202][0]="请选择";
				...
				$sub_arr[3202][320282]="宜兴市";$l_arr[3203]="徐州市";
				$sub_arr[3203]=[];
				$sub_arr[3203][0]="请选择";
				...
				$sub_arr[3203][320382]="邳州市";$l_arr[3204]="常州市";
				$sub_arr[3204]=[];
				$sub_arr[3204][0]="请选择";
				...
				$sub_arr[3204][320482]="金坛市";$l_arr[3205]="苏州市";
				$sub_arr[3205]=[];
				$sub_arr[3205][0]="请选择";
				...
				$sub_arr[3205][320585]="太仓市";$l_arr[3206]="南通市";
				$sub_arr[3206]=[];
				$sub_arr[3206][0]="请选择";
				...
				$sub_arr[3206][320684]="海门市";$l_arr[3207]="连云港市";
				$sub_arr[3207]=[];
				$sub_arr[3207][0]="请选择";
				...
				$sub_arr[3207][320724]="灌南县";$l_arr[3208]="淮安市";
				$sub_arr[3208]=[];
				$sub_arr[3208][0]="请选择";
				...
				$sub_arr[3208][320831]="金湖县";$l_arr[3209]="盐城市";
				$sub_arr[3209]=[];
				$sub_arr[3209][0]="请选择";
				...
				$sub_arr[3209][320982]="大丰市";$l_arr[3210]="扬州市";
				$sub_arr[3210]=[];
				$sub_arr[3210][0]="请选择";
				...
				$sub_arr[3210][321088]="江都市";$l_arr[3211]="镇江市";
				$sub_arr[3211]=[];
				$sub_arr[3211][0]="请选择";
				...
				$sub_arr[3211][321183]="句容市";$l_arr[3212]="泰州市";
				$sub_arr[3212]=[];
				$sub_arr[3212][0]="请选择";
				...
				$sub_arr[3212][321284]="姜堰市";$l_arr[3213]="宿迁市";
				$sub_arr[3213]=[];
				$sub_arr[3213][0]="请选择";
				...
				$sub_arr[3213][321324]="泗洪县";$l_arr[3301]="杭州市";
				$sub_arr[3301]=[];
				$sub_arr[3301][0]="请选择";
				...
				$sub_arr[3301][330185]="临安市";$l_arr[3302]="宁波市";
				$sub_arr[3302]=[];
				$sub_arr[3302][0]="请选择";
				...
				$sub_arr[3302][330283]="奉化市";$l_arr[3303]="温州市";
				$sub_arr[3303]=[];
				$sub_arr[3303][0]="请选择";
				...
				$sub_arr[3303][330382]="乐清市";$l_arr[3304]="嘉兴市";
				$sub_arr[3304]=[];
				$sub_arr[3304][0]="请选择";
				...
				$sub_arr[3304][330483]="桐乡市";$l_arr[3305]="湖州市";
				$sub_arr[3305]=[];
				$sub_arr[3305][0]="请选择";
				...
				$sub_arr[3305][330523]="安吉县";$l_arr[3306]="绍兴市";
				$sub_arr[3306]=[];
				$sub_arr[3306][0]="请选择";
				...
				$sub_arr[3306][330683]="嵊州市";$l_arr[3307]="金华市";
				$sub_arr[3307]=[];
				$sub_arr[3307][0]="请选择";
				...
				$sub_arr[3307][330784]="永康市";$l_arr[3308]="衢州市";
				$sub_arr[3308]=[];
				$sub_arr[3308][0]="请选择";
				...
				$sub_arr[3308][330881]="江山市";$l_arr[3309]="舟山市";
				$sub_arr[3309]=[];
				$sub_arr[3309][0]="请选择";
				$sub_arr[3309][330902]="定海区";
				$sub_arr[3309][330903]="普陀区";
				$sub_arr[3309][330921]="岱山县";
				$sub_arr[3309][330922]="嵊泗县";$l_arr[3310]="台州市";
				$sub_arr[3310]=[];
				$sub_arr[3310][0]="请选择";
				...
				$sub_arr[3310][331082]="临海市";$l_arr[3311]="丽水市";
				$sub_arr[3311]=[];
				$sub_arr[3311][0]="请选择";
				...
				$sub_arr[3311][331181]="龙泉市";$l_arr[3401]="合肥市";
				$sub_arr[3401]=[];
				$sub_arr[3401][0]="请选择";
				...
				$sub_arr[3401][340123]="肥西县";$l_arr[3402]="芜湖市";
				$sub_arr[3402]=[];
				$sub_arr[3402][0]="请选择";
				...
				$sub_arr[3402][340223]="南陵县";$l_arr[3403]="蚌埠市";
				$sub_arr[3403]=[];
				$sub_arr[3403][0]="请选择";
				...
				$sub_arr[3403][340323]="固镇县";$l_arr[3404]="淮南市";
				$sub_arr[3404]=[];
				$sub_arr[3404][0]="请选择";
				...
				$sub_arr[3404][340421]="凤台县";$l_arr[3405]="马鞍山市";
				$sub_arr[3405]=[];
				$sub_arr[3405][0]="请选择";
				...
				$sub_arr[3408][340881]="桐城市";$l_arr[3410]="黄山市";
				$sub_arr[3410]=[];
				$sub_arr[3410][0]="请选择";
				...
				$sub_arr[3410][341024]="祁门县";$l_arr[3411]="滁州市";
				$sub_arr[3411]=[];
				$sub_arr[3411][0]="请选择";
				...
				$sub_arr[3411][341182]="明光市";$l_arr[3412]="阜阳市";
				$sub_arr[3412]=[];
				$sub_arr[3412][0]="请选择";
				...
				$sub_arr[3412][341282]="界首市";$l_arr[3413]="宿州市";
				$sub_arr[3413]=[];
				$sub_arr[3413][0]="请选择";
				...
				$sub_arr[3413][341324]="泗县";$l_arr[3414]="巢湖市";
				$sub_arr[3414]=[];
				$sub_arr[3414][0]="请选择";
				$sub_arr[3414][341402]="居巢区";
				$sub_arr[3414][341421]="庐江县";
				$sub_arr[3414][341422]="无为县";
				$sub_arr[3414][341423]="和县";$l_arr[3415]="六安市";
				$sub_arr[3415]=[];
				$sub_arr[3415][0]="请选择";
				...
				$sub_arr[3418][341881]="宁国市";$l_arr[3501]="福州市";
				$sub_arr[3501]=[];
				$sub_arr[3501][0]="请选择";
				...
				$sub_arr[3501][350182]="长乐市";$l_arr[3502]="厦门市";
				$sub_arr[3502]=[];
				$sub_arr[3502][0]="请选择";
				...
				$sub_arr[3502][350213]="翔安区";$l_arr[3503]="莆田市";
				$sub_arr[3503]=[];
				$sub_arr[3503][0]="请选择";
				...
				$sub_arr[3503][350322]="仙游县";$l_arr[3504]="三明市";
				$sub_arr[3504]=[];
				$sub_arr[3504][0]="请选择";
				...
				$sub_arr[3504][350481]="永安市";$l_arr[3505]="泉州市";
				$sub_arr[3505]=[];
				$sub_arr[3505][0]="请选择";
				...
				$sub_arr[3505][350583]="南安市";$l_arr[3506]="漳州市";
				$sub_arr[3506]=[];
				$sub_arr[3506][0]="请选择";
				...
				$sub_arr[3506][350681]="龙海市";$l_arr[3507]="南平市";
				$sub_arr[3507]=[];
				$sub_arr[3507][0]="请选择";
				...
				$sub_arr[3507][350784]="建阳市";$l_arr[3508]="龙岩市";
				$sub_arr[3508]=[];
				$sub_arr[3508][0]="请选择";
				...
				$sub_arr[3508][350881]="漳平市";$l_arr[3509]="宁德市";
				$sub_arr[3509]=[];
				$sub_arr[3509][0]="请选择";
				...
				$sub_arr[3509][350982]="福鼎市";$l_arr[3601]="南昌市";
				$sub_arr[3601]=[];
				$sub_arr[3601][0]="请选择";
				...
				$sub_arr[3601][360124]="进贤县";$l_arr[3602]="景德镇市";
				$sub_arr[3602]=[];
				$sub_arr[3602][0]="请选择";
				$sub_arr[3602][360202]="昌江区";
				$sub_arr[3602][360203]="珠山区";
				$sub_arr[3602][360222]="浮梁县";
				$sub_arr[3602][360281]="乐平市";$l_arr[3603]="萍乡市";
				$sub_arr[3603]=[];
				$sub_arr[3603][0]="请选择";
				...
				$sub_arr[3603][360323]="芦溪县";$l_arr[3604]="九江市";
				$sub_arr[3604]=[];
				$sub_arr[3604][0]="请选择";
				...
				$sub_arr[3604][360481]="瑞昌市";$l_arr[3605]="新余市";
				$sub_arr[3605]=[];
				$sub_arr[3605][0]="请选择";
				$sub_arr[3605][360502]="渝水区";
				$sub_arr[3605][360521]="分宜县";$l_arr[3606]="鹰潭市";
				$sub_arr[3606]=[];
				$sub_arr[3606][0]="请选择";
				$sub_arr[3606][360602]="月湖区";
				$sub_arr[3606][360622]="余江县";
				$sub_arr[3606][360681]="贵溪市";$l_arr[3607]="赣州市";
				$sub_arr[3607]=[];
				$sub_arr[3607][0]="请选择";
				...
				$sub_arr[3607][360782]="南康市";$l_arr[3608]="吉安市";
				$sub_arr[3608]=[];
				$sub_arr[3608][0]="请选择";
				...
				$sub_arr[3608][360881]="井冈山市";$l_arr[3609]="宜春市";
				$sub_arr[3609]=[];
				$sub_arr[3609][0]="请选择";
				...
				$sub_arr[3609][360983]="高安市";$l_arr[3610]="抚州市";
				$sub_arr[3610]=[];
				$sub_arr[3610][0]="请选择";
				...
				$sub_arr[3610][361030]="广昌县";$l_arr[3611]="上饶市";
				$sub_arr[3611]=[];
				$sub_arr[3611][0]="请选择";
				...
				$sub_arr[3611][361181]="德兴市";$l_arr[3701]="济南市";
				$sub_arr[3701]=[];
				$sub_arr[3701][0]="请选择";
				...
				$sub_arr[3701][370181]="章丘市";$l_arr[3702]="青岛市";
				$sub_arr[3702]=[];
				$sub_arr[3702][0]="请选择";
				...
				$sub_arr[3702][370285]="莱西市";$l_arr[3703]="淄博市";
				$sub_arr[3703]=[];
				$sub_arr[3703][0]="请选择";
				...
				$sub_arr[3703][370323]="沂源县";$l_arr[3704]="枣庄市";
				$sub_arr[3704]=[];
				$sub_arr[3704][0]="请选择";
				...
				$sub_arr[3704][370481]="滕州市";$l_arr[3705]="东营市";
				$sub_arr[3705]=[];
				$sub_arr[3705][0]="请选择";
				...
				$sub_arr[3705][370523]="广饶县";$l_arr[3706]="烟台市";
				$sub_arr[3706]=[];
				$sub_arr[3706][0]="请选择";
				...
				$sub_arr[3706][370687]="海阳市";$l_arr[3707]="潍坊市";
				$sub_arr[3707]=[];
				$sub_arr[3707][0]="请选择";
				...
				$sub_arr[3707][370786]="昌邑市";$l_arr[3708]="济宁市";
				$sub_arr[3708]=[];
				$sub_arr[3708][0]="请选择";
				...
				$sub_arr[3708][370883]="邹城市";$l_arr[3709]="泰安市";
				$sub_arr[3709]=[];
				$sub_arr[3709][0]="请选择";
				...
				$sub_arr[3713][371329]="临沭县";$l_arr[3714]="德州市";
				$sub_arr[3714]=[];
				$sub_arr[3714][0]="请选择";
				...
				$sub_arr[3714][371482]="禹城市";$l_arr[3715]="聊城市";
				$sub_arr[3715]=[];
				$sub_arr[3715][0]="请选择";
				...
				$sub_arr[3715][371581]="临清市";$l_arr[3716]="滨州市";
				$sub_arr[3716]=[];
				$sub_arr[3716][0]="请选择";
				...
				$sub_arr[3716][371626]="邹平县";$l_arr[3717]="菏泽市";
				$sub_arr[3717]=[];
				$sub_arr[3717][0]="请选择";
				...
				$sub_arr[3717][371728]="东明县";$l_arr[4101]="郑州市";
				$sub_arr[4101]=[];
				$sub_arr[4101][0]="请选择";
				...
				$sub_arr[4101][410185]="登封市";$l_arr[4102]="开封市";
				$sub_arr[4102]=[];
				$sub_arr[4102][0]="请选择";
				...
				$sub_arr[4102][410225]="兰考县";$l_arr[4103]="洛阳市";
				$sub_arr[4103]=[];
				$sub_arr[4103][0]="请选择";
				...
				$sub_arr[4103][410381]="偃师市";$l_arr[4104]="平顶山市";
				$sub_arr[4104]=[];
				$sub_arr[4104][0]="请选择";
				...
				$sub_arr[4104][410482]="汝州市";$l_arr[4105]="安阳市";
				$sub_arr[4105]=[];
				$sub_arr[4105][0]="请选择";
				...
				$sub_arr[4105][410581]="林州市";$l_arr[4106]="鹤壁市";
				$sub_arr[4106]=[];
				$sub_arr[4106][0]="请选择";
				...
				$sub_arr[4106][410622]="淇县";$l_arr[4107]="新乡市";
				$sub_arr[4107]=[];
				$sub_arr[4107][0]="请选择";
				...
				$sub_arr[4107][410782]="辉县市";$l_arr[4108]="焦作市";
				$sub_arr[4108]=[];
				$sub_arr[4108][0]="请选择";
				...
				$sub_arr[4108][410883]="孟州市";$l_arr[4109]="濮阳市";
				$sub_arr[4109]=[];
				$sub_arr[4109][0]="请选择";
				...
				$sub_arr[4109][410928]="濮阳县";$l_arr[4110]="许昌市";
				$sub_arr[4110]=[];
				$sub_arr[4110][0]="请选择";
				...
				$sub_arr[4110][411082]="长葛市";$l_arr[4111]="漯河市";
				$sub_arr[4111]=[];
				$sub_arr[4111][0]="请选择";
				...
				$sub_arr[4111][411122]="临颍县";$l_arr[4112]="三门峡市";
				$sub_arr[4112]=[];
				$sub_arr[4112][0]="请选择";
				...
				$sub_arr[4112][411282]="灵宝市";$l_arr[4113]="南阳市";
				$sub_arr[4113]=[];
				$sub_arr[4113][0]="请选择";
				...
				$sub_arr[4113][411381]="邓州市";$l_arr[4114]="商丘市";
				$sub_arr[4114]=[];
				$sub_arr[4114][0]="请选择";
				...
				$sub_arr[4114][411481]="永城市";$l_arr[4115]="信阳市";
				$sub_arr[4115]=[];
				$sub_arr[4115][0]="请选择";
				...
				$sub_arr[4115][411528]="息县";$l_arr[4116]="周口市";
				$sub_arr[4116]=[];
				$sub_arr[4116][0]="请选择";
				...
				$sub_arr[4116][411681]="项城市";$l_arr[4117]="驻马店市";
				$sub_arr[4117]=[];
				$sub_arr[4117][0]="请选择";
				...
				$sub_arr[4117][411729]="新蔡县";$l_arr[4201]="武汉市";
				$sub_arr[4201]=[];
				$sub_arr[4201][0]="请选择";
				...
				$sub_arr[4201][420191]="武汉经济开发区";$l_arr[4202]="黄石市";
				$sub_arr[4202]=[];
				$sub_arr[4202][0]="请选择";
				...
				$sub_arr[4202][420281]="大冶市";$l_arr[4203]="十堰市";
				$sub_arr[4203]=[];
				$sub_arr[4203][0]="请选择";
				...
				$sub_arr[4203][420381]="丹江口市";$l_arr[4205]="宜昌市";
				$sub_arr[4205]=[];
				$sub_arr[4205][0]="请选择";
				...
				$sub_arr[4205][420583]="枝江市";$l_arr[4206]="襄阳市";
				$sub_arr[4206]=[];
				$sub_arr[4206][0]="请选择";
				...
				$sub_arr[4206][420687]="鱼梁洲开发区";$l_arr[4207]="鄂州市";
				$sub_arr[4207]=[];
				$sub_arr[4207][0]="请选择";
				...
				$sub_arr[4207][420792]="鄂州经济开发区";$l_arr[4208]="荆门市";
				$sub_arr[4208]=[];
				$sub_arr[4208][0]="请选择";
				...
				$sub_arr[4208][420892]="荆门经济开发区";$l_arr[4209]="孝感市";
				$sub_arr[4209]=[];
				$sub_arr[4209][0]="请选择";
				...
				$sub_arr[4209][420984]="汉川市";$l_arr[4210]="荆州市";
				$sub_arr[4210]=[];
				$sub_arr[4210][0]="请选择";
				...
				$sub_arr[4210][421091]="荆州经济开发区";$l_arr[4211]="黄冈市";
				$sub_arr[4211]=[];
				$sub_arr[4211][0]="请选择";
				...
				$sub_arr[4211][421191]="龙感湖管理区";$l_arr[4212]="咸宁市";
				$sub_arr[4212]=[];
				$sub_arr[4212][0]="请选择";
				...
				$sub_arr[4212][421291]="湖北省咸宁市咸宁经济开发区";$l_arr[4213]="随州市";
				$sub_arr[4213]=[];
				$sub_arr[4213][0]="请选择";
				$sub_arr[4213][421302]="曾都区";
				$sub_arr[4213][421321]="随县";
				$sub_arr[4213][421381]="广水市";$l_arr[4228]="恩施州";
				$sub_arr[4228]=[];
				$sub_arr[4228][0]="请选择";
				...
				$sub_arr[4228][422828]="鹤峰县";$l_arr[4301]="长沙市";
				$sub_arr[4301]=[];
				$sub_arr[4301][0]="请选择";
				...
				$sub_arr[4301][430181]="浏阳市";$l_arr[4302]="株洲市";
				$sub_arr[4302]=[];
				$sub_arr[4302][0]="请选择";
				...
				$sub_arr[4302][430281]="醴陵市";$l_arr[4303]="湘潭市";
				$sub_arr[4303]=[];
				$sub_arr[4303][0]="请选择";
				...
				$sub_arr[4303][430382]="韶山市";$l_arr[4304]="衡阳市";
				$sub_arr[4304]=[];
				$sub_arr[4304][0]="请选择";
				...
				$sub_arr[4304][430482]="常宁市";$l_arr[4305]="邵阳市";
				$sub_arr[4305]=[];
				$sub_arr[4305][0]="请选择";
				...
				$sub_arr[4305][430581]="武冈市";$l_arr[4306]="岳阳市";
				$sub_arr[4306]=[];
				$sub_arr[4306][0]="请选择";
				...
				$sub_arr[4306][430682]="临湘市";$l_arr[4307]="常德市";
				$sub_arr[4307]=[];
				$sub_arr[4307][0]="请选择";
				...
				$sub_arr[4307][430781]="津市市";$l_arr[4308]="张家界市";
				$sub_arr[4308]=[];
				$sub_arr[4308][0]="请选择";
				$sub_arr[4308][430802]="永定区";
				$sub_arr[4308][430811]="武陵源区";
				$sub_arr[4308][430821]="慈利县";
				$sub_arr[4308][430822]="桑植县";$l_arr[4309]="益阳市";
				$sub_arr[4309]=[];
				$sub_arr[4309][0]="请选择";
				...
				$sub_arr[4309][430981]="沅江市";$l_arr[4310]="郴州市";
				$sub_arr[4310]=[];
				$sub_arr[4310][0]="请选择";
				...
				$sub_arr[4310][431081]="资兴市";$l_arr[4311]="永州市";
				$sub_arr[4311]=[];
				$sub_arr[4311][0]="请选择";
				...
				$sub_arr[4311][431129]="江华";$l_arr[4312]="怀化市";
				$sub_arr[4312]=[];
				$sub_arr[4312][0]="请选择";
				...
				$sub_arr[4312][431281]="洪江市";$l_arr[4313]="娄底市";
				$sub_arr[4313]=[];
				$sub_arr[4313][0]="请选择";
				...
				$sub_arr[4313][431382]="涟源市";$l_arr[4331]="湘西";
				$sub_arr[4331]=[];
				$sub_arr[4331][0]="请选择";
				...
				$sub_arr[4331][433130]="龙山县";$l_arr[4401]="广州市";
				$sub_arr[4401]=[];
				$sub_arr[4401][0]="请选择";
				...
				$sub_arr[4401][440184]="从化市";$l_arr[4402]="韶关市";
				$sub_arr[4402]=[];
				$sub_arr[4402][0]="请选择";
				...
				$sub_arr[4402][440282]="南雄市";$l_arr[4403]="深圳市";
				$sub_arr[4403]=[];
				$sub_arr[4403][0]="请选择";
				...
				$sub_arr[4403][440308]="盐田区";$l_arr[4404]="珠海市";
				$sub_arr[4404]=[];
				$sub_arr[4404][0]="请选择";
				$sub_arr[4404][440402]="香洲区";
				$sub_arr[4404][440403]="斗门区";
				$sub_arr[4404][440404]="金湾区";$l_arr[4405]="汕头市";
				$sub_arr[4405]=[];
				$sub_arr[4405][0]="请选择";
				...
				$sub_arr[4405][440523]="南澳县";$l_arr[4406]="佛山市";
				$sub_arr[4406]=[];
				$sub_arr[4406][0]="请选择";
				...
				$sub_arr[4406][440608]="高明区";$l_arr[4407]="江门市";
				$sub_arr[4407]=[];
				$sub_arr[4407][0]="请选择";
				...
				$sub_arr[4407][440785]="恩平市";$l_arr[4408]="湛江市";
				$sub_arr[4408]=[];
				$sub_arr[4408][0]="请选择";
				...
				$sub_arr[4408][440883]="吴川市";$l_arr[4409]="茂名市";
				$sub_arr[4409]=[];
				$sub_arr[4409][0]="请选择";
				...
				$sub_arr[4409][440983]="信宜市";$l_arr[4412]="肇庆市";
				$sub_arr[4412]=[];
				$sub_arr[4412][0]="请选择";
				...
				$sub_arr[4412][441284]="四会市";$l_arr[4413]="惠州市";
				$sub_arr[4413]=[];
				$sub_arr[4413][0]="请选择";
				...
				$sub_arr[4413][441324]="龙门县";$l_arr[4414]="梅州市";
				$sub_arr[4414]=[];
				$sub_arr[4414][0]="请选择";
				...
				$sub_arr[4414][441481]="兴宁市";$l_arr[4415]="汕尾市";
				$sub_arr[4415]=[];
				$sub_arr[4415][0]="请选择";
				$sub_arr[4415][441502]="城区";
				$sub_arr[4415][441521]="海丰县";
				$sub_arr[4415][441523]="陆河县";
				$sub_arr[4415][441581]="陆丰市";$l_arr[4416]="河源市";
				$sub_arr[4416]=[];
				$sub_arr[4416][0]="请选择";
				...
				$sub_arr[4416][441625]="东源县";$l_arr[4417]="阳江市";
				$sub_arr[4417]=[];
				$sub_arr[4417][0]="请选择";
				$sub_arr[4417][441702]="江城区";
				$sub_arr[4417][441721]="阳西县";
				$sub_arr[4417][441723]="阳东县";
				$sub_arr[4417][441781]="阳春市";$l_arr[4418]="清远市";
				$sub_arr[4418]=[];
				$sub_arr[4418][0]="请选择";
				...
				$sub_arr[4418][441882]="连州市";$l_arr[4451]="潮州市";
				$sub_arr[4451]=[];
				$sub_arr[4451][0]="请选择";
				$sub_arr[4451][445101]="枫溪区";
				$sub_arr[4451][445102]="湘桥区";
				$sub_arr[4451][445121]="潮安县";
				$sub_arr[4451][445122]="饶平县";$l_arr[4452]="揭阳市";
				$sub_arr[4452]=[];
				$sub_arr[4452][0]="请选择";
				...
				$sub_arr[4452][445281]="普宁市";$l_arr[4453]="云浮市";
				$sub_arr[4453]=[];
				$sub_arr[4453][0]="请选择";
				...
				$sub_arr[4453][445381]="罗定市";$l_arr[4501]="南宁市";
				$sub_arr[4501]=[];
				$sub_arr[4501][0]="请选择";
				...
				$sub_arr[4501][450127]="横县";$l_arr[4502]="柳州市";
				$sub_arr[4502]=[];
				$sub_arr[4502][0]="请选择";
				...
				$sub_arr[4502][450226]="三江";$l_arr[4503]="桂林市";
				$sub_arr[4503]=[];
				$sub_arr[4503][0]="请选择";
				...
				$sub_arr[4503][450332]="恭城";$l_arr[4504]="梧州市";
				$sub_arr[4504]=[];
				$sub_arr[4504][0]="请选择";
				...
				$sub_arr[4508][450881]="桂平市";$l_arr[4509]="玉林市";
				$sub_arr[4509]=[];
				$sub_arr[4509][0]="请选择";
				...
				$sub_arr[4509][450981]="北流市";$l_arr[4510]="百色市";
				$sub_arr[4510]=[];
				$sub_arr[4510][0]="请选择";
				...
				$sub_arr[4510][451031]="隆林";$l_arr[4511]="贺州市";
				$sub_arr[4511]=[];
				$sub_arr[4511][0]="请选择";
				$sub_arr[4511][451102]="八步区";
				$sub_arr[4511][451121]="昭平县";
				$sub_arr[4511][451122]="钟山县";
				$sub_arr[4511][451123]="富川";$l_arr[4512]="河池市";
				$sub_arr[4512]=[];
				$sub_arr[4512][0]="请选择";
				...
				$sub_arr[4512][451281]="宜州市";$l_arr[4513]="来宾市";
				$sub_arr[4513]=[];
				$sub_arr[4513][0]="请选择";
				...
				$sub_arr[4513][451381]="合山市";$l_arr[4514]="崇左市";
				$sub_arr[4514]=[];
				$sub_arr[4514][0]="请选择";
				...
				$sub_arr[4514][451481]="凭祥市";$l_arr[4601]="海口市";
				$sub_arr[4601]=[];
				$sub_arr[4601][0]="请选择";
				$sub_arr[4601][460105]="秀英区";
				$sub_arr[4601][460106]="龙华区";
				$sub_arr[4601][460107]="琼山区";
				$sub_arr[4601][460108]="美兰区";$l_arr[5101]="成都市";
				$sub_arr[5101]=[];
				$sub_arr[5101][0]="请选择";
				...
				$sub_arr[5101][510185]="高新区";$l_arr[5103]="自贡市";
				$sub_arr[5103]=[];
				$sub_arr[5103][0]="请选择";
				...
				$sub_arr[5103][510322]="富顺县";$l_arr[5104]="攀枝花市";
				$sub_arr[5104]=[];
				$sub_arr[5104][0]="请选择";
				...
				$sub_arr[5104][510422]="盐边县";$l_arr[5105]="泸州市";
				$sub_arr[5105]=[];
				$sub_arr[5105][0]="请选择";
				...
				$sub_arr[5105][510525]="古蔺县";$l_arr[5106]="德阳市";
				$sub_arr[5106]=[];
				$sub_arr[5106][0]="请选择";
				...
				$sub_arr[5106][510683]="绵竹市";$l_arr[5107]="绵阳市";
				$sub_arr[5107]=[];
				$sub_arr[5107][0]="请选择";
				...
				$sub_arr[5107][510781]="江油市";$l_arr[5108]="广元市";
				$sub_arr[5108]=[];
				$sub_arr[5108][0]="请选择";
				...
				$sub_arr[5108][510824]="苍溪县";$l_arr[5109]="遂宁市";
				$sub_arr[5109]=[];
				$sub_arr[5109][0]="请选择";
				...
				$sub_arr[5109][510923]="大英县";$l_arr[5110]="内江市";
				$sub_arr[5110]=[];
				$sub_arr[5110][0]="请选择";
				...
				$sub_arr[5110][511028]="隆昌县";$l_arr[5111]="乐山市";
				$sub_arr[5111]=[];
				$sub_arr[5111][0]="请选择";
				...
				$sub_arr[5111][511181]="峨眉山市";$l_arr[5113]="南充市";
				$sub_arr[5113]=[];
				$sub_arr[5113][0]="请选择";
				...
				$sub_arr[5113][511381]="阆中市";$l_arr[5114]="眉山市";
				$sub_arr[5114]=[];
				$sub_arr[5114][0]="请选择";
				...
				$sub_arr[5114][511425]="青神县";$l_arr[5115]="宜宾市";
				$sub_arr[5115]=[];
				$sub_arr[5115][0]="请选择";
				...
				$sub_arr[5115][511529]="屏山县";$l_arr[5116]="广安市";
				$sub_arr[5116]=[];
				$sub_arr[5116][0]="请选择";
				...
				$sub_arr[5116][511681]="华蓥市";$l_arr[5117]="达州市";
				$sub_arr[5117]=[];
				$sub_arr[5117][0]="请选择";
				...
				$sub_arr[5117][511781]="万源市";$l_arr[5118]="雅安市";
				$sub_arr[5118]=[];
				$sub_arr[5118][0]="请选择";
				...
				$sub_arr[5132][513233]="红原县";$l_arr[5133]="甘孜";
				$sub_arr[5133]=[];
				$sub_arr[5133][0]="请选择";
				...
				$sub_arr[5133][513338]="得荣县";$l_arr[5134]="凉山";
				$sub_arr[5134]=[];
				$sub_arr[5134][0]="请选择";
				...
				$sub_arr[5134][513437]="雷波县";$l_arr[5201]="贵阳市";
				$sub_arr[5201]=[];
				$sub_arr[5201][0]="请选择";
				...
				$sub_arr[5201][520181]="清镇市";$l_arr[5202]="六盘水市";
				$sub_arr[5202]=[];
				$sub_arr[5202][0]="请选择";
				$sub_arr[5202][520201]="钟山区";
				$sub_arr[5202][520203]="六枝特区";
				$sub_arr[5202][520221]="水城县";
				$sub_arr[5202][520222]="盘县";$l_arr[5203]="遵义市";
				$sub_arr[5203]=[];
				$sub_arr[5203][0]="请选择";
				...
				$sub_arr[5203][520382]="仁怀市";$l_arr[5204]="安顺市";
				$sub_arr[5204]=[];
				$sub_arr[5204][0]="请选择";
				...
				$sub_arr[5204][520425]="紫云县";$l_arr[5205]="毕节市";
				$sub_arr[5205]=[];
				$sub_arr[5205][0]="请选择";
				...
				$sub_arr[5205][520528]="赫章县";$l_arr[5206]="铜仁市";
				$sub_arr[5206]=[];
				$sub_arr[5206][0]="请选择";
				...
				$sub_arr[5206][520630]="万山特区";$l_arr[5223]="黔西南";
				$sub_arr[5223]=[];
				$sub_arr[5223][0]="请选择";
				...
				$sub_arr[5223][522328]="安龙县";$l_arr[5226]="黔东南";
				$sub_arr[5226]=[];
				$sub_arr[5226][0]="请选择";
				...
				$sub_arr[5226][522636]="丹寨县";$l_arr[5227]="黔南布";
				$sub_arr[5227]=[];
				$sub_arr[5227][0]="请选择";
				...
				$sub_arr[5227][522732]="三都";$l_arr[5301]="昆明市";
				$sub_arr[5301]=[];
				$sub_arr[5301][0]="请选择";
				...
				$sub_arr[5301][530181]="安宁市";$l_arr[5303]="曲靖市";
				$sub_arr[5303]=[];
				$sub_arr[5303][0]="请选择";
				...
				$sub_arr[5303][530381]="宣威市";$l_arr[5304]="玉溪市";
				$sub_arr[5304]=[];
				$sub_arr[5304][0]="请选择";
				...
				$sub_arr[5304][530428]="元江县";$l_arr[5305]="保山市";
				$sub_arr[5305]=[];
				$sub_arr[5305][0]="请选择";
				...
				$sub_arr[5305][530524]="昌宁县";$l_arr[5306]="昭通市";
				$sub_arr[5306]=[];
				$sub_arr[5306][0]="请选择";
				...
				$sub_arr[5306][530630]="水富县";$l_arr[5307]="丽江市";
				$sub_arr[5307]=[];
				$sub_arr[5307][0]="请选择";
				...
				$sub_arr[5307][530724]="宁蒗";$l_arr[5308]="普洱市(*)";
				$sub_arr[5308]=[];
				$sub_arr[5308][0]="请选择";
				...
				$sub_arr[5308][530829]="西盟";$l_arr[5309]="临沧市";
				$sub_arr[5309]=[];
				$sub_arr[5309][0]="请选择";
				...
				$sub_arr[5309][530927]="沧源";$l_arr[5323]="楚雄";
				$sub_arr[5323]=[];
				$sub_arr[5323][0]="请选择";
				...
				$sub_arr[5323][532331]="禄丰县";$l_arr[5325]="红河";
				$sub_arr[5325]=[];
				$sub_arr[5325][0]="请选择";
				...
				$sub_arr[5325][532532]="河口";$l_arr[5326]="文山";
				$sub_arr[5326]=[];
				$sub_arr[5326][0]="请选择";
				...
				$sub_arr[5326][532628]="富宁县";$l_arr[5328]="西双版纳";
				$sub_arr[5328]=[];
				$sub_arr[5328][0]="请选择";
				$sub_arr[5328][532801]="景洪市";
				$sub_arr[5328][532822]="勐海县";
				$sub_arr[5328][532823]="勐腊县";$l_arr[5329]="大理";
				$sub_arr[5329]=[];
				$sub_arr[5329][0]="请选择";
				...
				$sub_arr[5329][532932]="鹤庆县";$l_arr[5331]="德宏";
				$sub_arr[5331]=[];
				$sub_arr[5331][0]="请选择";
				...
				$sub_arr[5401][540127]="墨竹工卡县";$l_arr[5421]="昌都地区";
				$sub_arr[5421]=[];
				$sub_arr[5421][0]="请选择";
				...
				$sub_arr[5421][542133]="边坝县";$l_arr[5422]="山南地区";
				$sub_arr[5422]=[];
				$sub_arr[5422][0]="请选择";
				...
				$sub_arr[5422][542233]="浪卡子县";$l_arr[5423]="日喀则地区";
				$sub_arr[5423]=[];
				$sub_arr[5423][0]="请选择";
				...
				$sub_arr[5423][542338]="岗巴县";$l_arr[5424]="那曲地区";
				$sub_arr[5424]=[];
				$sub_arr[5424][0]="请选择";
				...
				$sub_arr[5424][542430]="尼玛县";$l_arr[5425]="阿里地区";
				$sub_arr[5425]=[];
				$sub_arr[5425][0]="请选择";
				...
				$sub_arr[5425][542527]="措勤县";$l_arr[5426]="林芝地区";
				$sub_arr[5426]=[];
				$sub_arr[5426][0]="请选择";
				...
				$sub_arr[5426][542627]="朗县";$l_arr[6101]="西安市";
				$sub_arr[6101]=[];
				$sub_arr[6101][0]="请选择";
				...
				$sub_arr[6101][610126]="高陵县";$l_arr[6102]="铜川市";
				$sub_arr[6102]=[];
				$sub_arr[6102][0]="请选择";
				...
				$sub_arr[6102][610222]="宜君县";$l_arr[6103]="宝鸡市";
				$sub_arr[6103]=[];
				$sub_arr[6103][0]="请选择";
				...
				$sub_arr[6103][610331]="太白县";$l_arr[6104]="咸阳市";
				$sub_arr[6104]=[];
				$sub_arr[6104][0]="请选择";
				...
				$sub_arr[6104][610481]="兴平市";$l_arr[6105]="渭南市";
				$sub_arr[6105]=[];
				$sub_arr[6105][0]="请选择";
				...
				$sub_arr[6105][610582]="华阴市";$l_arr[6106]="延安市";
				$sub_arr[6106]=[];
				$sub_arr[6106][0]="请选择";
				...
				$sub_arr[6106][610632]="黄陵县";$l_arr[6107]="汉中市";
				$sub_arr[6107]=[];
				$sub_arr[6107][0]="请选择";
				...
				$sub_arr[6107][610751]="经济开发区";$l_arr[6108]="榆林市";
				$sub_arr[6108]=[];
				$sub_arr[6108][0]="请选择";
				...
				$sub_arr[6108][610831]="子洲县";$l_arr[6109]="安康市";
				$sub_arr[6109]=[];
				$sub_arr[6109][0]="请选择";
				...
				$sub_arr[6109][610929]="白河县";$l_arr[6110]="商洛市";
				$sub_arr[6110]=[];
				$sub_arr[6110][0]="请选择";
				...
				$sub_arr[6110][611026]="柞水县";$l_arr[6151]="杨凌示范区";
				$sub_arr[6151]=[];
				$sub_arr[6151][0]="请选择";
				$sub_arr[6151][615101]="杨凌区";$l_arr[6201]="兰州市";
				$sub_arr[6201]=[];
				$sub_arr[6201][0]="请选择";
				...
				$sub_arr[6201][620123]="榆中县";$l_arr[6203]="金昌市";
				$sub_arr[6203]=[];
				$sub_arr[6203][0]="请选择";
				$sub_arr[6203][620302]="金川区";
				$sub_arr[6203][620321]="永昌县";$l_arr[6204]="白银市";
				$sub_arr[6204]=[];
				$sub_arr[6204][0]="请选择";
				...
				$sub_arr[6204][620423]="景泰县";$l_arr[6205]="天水市";
				$sub_arr[6205]=[];
				$sub_arr[6205][0]="请选择";
				...
				$sub_arr[6205][620525]="张家川";$l_arr[6206]="武威市";
				$sub_arr[6206]=[];
				$sub_arr[6206][0]="请选择";
				$sub_arr[6206][620602]="凉州区";
				$sub_arr[6206][620621]="民勤县";
				$sub_arr[6206][620622]="古浪县";
				$sub_arr[6206][620623]="天祝";$l_arr[6207]="张掖市";
				$sub_arr[6207]=[];
				$sub_arr[6207][0]="请选择";
				...
				$sub_arr[6207][620725]="山丹县";$l_arr[6208]="平凉市";
				$sub_arr[6208]=[];
				$sub_arr[6208][0]="请选择";
				...
				$sub_arr[6208][620826]="静宁县";$l_arr[6209]="酒泉市";
				$sub_arr[6209]=[];
				$sub_arr[6209][0]="请选择";
				...
				$sub_arr[6209][620982]="敦煌市";$l_arr[6210]="庆阳市";
				$sub_arr[6210]=[];
				$sub_arr[6210][0]="请选择";
				...
				$sub_arr[6210][621027]="镇原县";$l_arr[6211]="定西市";
				$sub_arr[6211]=[];
				$sub_arr[6211][0]="请选择";
				...
				$sub_arr[6211][621126]="岷县";$l_arr[6212]="陇南市";
				$sub_arr[6212]=[];
				$sub_arr[6212][0]="请选择";
				...
				$sub_arr[6212][621228]="两当县";$l_arr[6229]="临夏";
				$sub_arr[6229]=[];
				$sub_arr[6229][0]="请选择";
				...
				$sub_arr[6229][622927]="积石山";$l_arr[6230]="甘南";
				$sub_arr[6230]=[];
				$sub_arr[6230][0]="请选择";
				...
				$sub_arr[6230][623027]="夏河县";$l_arr[6301]="西宁市";
				$sub_arr[6301]=[];
				$sub_arr[6301][0]="请选择";
				...
				$sub_arr[6301][630123]="湟源县";$l_arr[6321]="海东地区";
				$sub_arr[6321]=[];
				$sub_arr[6321][0]="请选择";
				...
				$sub_arr[6325][632525]="贵南县";$l_arr[6326]="果洛";
				$sub_arr[6326]=[];
				$sub_arr[6326][0]="请选择";
				...
				$sub_arr[6326][632626]="玛多县";$l_arr[6327]="玉树";
				$sub_arr[6327]=[];
				$sub_arr[6327][0]="请选择";
				...
				$sub_arr[6327][632726]="曲麻莱县";$l_arr[6328]="海西";
				$sub_arr[6328]=[];
				$sub_arr[6328][0]="请选择";
				...
				$sub_arr[6328][632823]="天峻县";$l_arr[6401]="银川市";
				$sub_arr[6401]=[];
				$sub_arr[6401][0]="请选择";
				...
				$sub_arr[6401][640181]="灵武市";$l_arr[6402]="石嘴山市";
				$sub_arr[6402]=[];
				$sub_arr[6402][0]="请选择";
				$sub_arr[6402][640202]="大武口区";
				$sub_arr[6402][640205]="惠农区";
				$sub_arr[6402][640221]="平罗县";$l_arr[6403]="吴忠市";
				$sub_arr[6403]=[];
				$sub_arr[6403][0]="请选择";
				...
				$sub_arr[6403][640381]="青铜峡市";$l_arr[6404]="固原市";
				$sub_arr[6404]=[];
				$sub_arr[6404][0]="请选择";
				...
				$sub_arr[6404][640425]="彭阳县";$l_arr[6405]="中卫市";
				$sub_arr[6405]=[];
				$sub_arr[6405][0]="请选择";
				$sub_arr[6405][640502]="沙坡头区";
				$sub_arr[6405][640521]="中宁县";
				$sub_arr[6405][640522]="海原县";$l_arr[6501]="乌鲁木齐市";
				$sub_arr[6501]=[];
				$sub_arr[6501][0]="请选择";
				...
				$sub_arr[6523][652328]="木垒哈萨克";$l_arr[6527]="博尔塔拉";
				$sub_arr[6527]=[];
				$sub_arr[6527][0]="请选择";
				$sub_arr[6527][652701]="博乐市";
				$sub_arr[6527][652722]="精河县";
				$sub_arr[6527][652723]="温泉县";$l_arr[6528]="巴音郭楞";
				$sub_arr[6528]=[];
				$sub_arr[6528][0]="请选择";
				...
				$sub_arr[6528][652829]="博湖县";$l_arr[6529]="阿克苏地区";
				$sub_arr[6529]=[];
				$sub_arr[6529][0]="请选择";
				...
				$sub_arr[6529][652929]="柯坪县";$l_arr[6530]="克孜勒";
				$sub_arr[6530]=[];
				$sub_arr[6530][0]="请选择";
				$sub_arr[6530][653001]="阿图什市";
				$sub_arr[6530][653022]="阿克陶县";
				$sub_arr[6530][653023]="阿合奇县";
				$sub_arr[6530][653024]="乌恰县";$l_arr[6531]="喀什地区";
				$sub_arr[6531]=[];
				$sub_arr[6531][0]="请选择";
				...
				$sub_arr[6531][653131]="塔什";$l_arr[6532]="和田地区";
				$sub_arr[6532]=[];
				$sub_arr[6532][0]="请选择";
				...
				$sub_arr[6532][653227]="民丰县";$l_arr[6540]="伊犁";
				$sub_arr[6540]=[];
				$sub_arr[6540][0]="请选择";
				...
				$sub_arr[6540][654028]="尼勒克县";$l_arr[6542]="塔城地区";
				$sub_arr[6542]=[];
				$sub_arr[6542][0]="请选择";
				...
				$sub_arr[6542][654226]="和布克赛尔";$l_arr[6543]="阿勒泰地区";
				$sub_arr[6543]=[];
				$sub_arr[6543][0]="请选择";
				...
				$sub_arr[6543][654326]="吉木乃县";$l_arr[6590]="自治区直辖县级行政单位";
				$sub_arr[6590]=[];
				$sub_arr[6590][0]="请选择";
