                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/admin/index/Sort.html" method="post">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" name="sid[]" value="{$value.sid}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="orderby[{$value.sid}]" value="{$value.orderby}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="sname[{$value.sid}]" value="{$value.sname}">
                                                    </td>
                                                </tr>
                                                {/foreach}
                                                {/if}
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="submit" class="btn btn-default" name="update" value="修改">
                                                    </td>
                                                    <td></td>
                                                </tr>
                                            </tbody>
