                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/admin/index/orderRecover.html" method="post">
                                        <table class="datatable table table-striped" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" name="oid[]" value="{$value.oid}">
                                                    </td>
                                        ...
                                        <input type="submit" name="recover" class="btn btn-default" value="恢复">
                                    </form>
                                </div>
                            </div>
                        </div>
