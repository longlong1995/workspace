            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">修改LOGO不能为空</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <form action="/admin/index/logo.html" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <p>选择你要上传的图片</p>
                                        <div class="sub-title">网站LOGO</div>
                                        <div>
                                            <input type="file" name="web_logo"  />
                                            <img src="{$Think.const.WEB_LOGO}" height="80">
                                        </div>
