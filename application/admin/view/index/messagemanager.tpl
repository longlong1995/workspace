                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/admin/index/messageManager.html" method="post">
                                        <table class="datatable table table-striped" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" name="mid[]" value="{$value.mid}">
                                                    </td>
                                                    <td>{$value.name}</td>
                                                    <td>{$value.email}</td>
                                                    <td>{$value.sname}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a>已处理</a>
                                                        {else}
                                                        <a href="/admin/index/messageManager.html?mid={$value.mid}">未处理</a>
                                                        {/if}
                                                    </td>
                                                </tr>
                                                {/foreach}
                                        ...
                                        <input type="submit" class="btn btn-default" name="dosubmit" value="放入回收站">
                                    </form>
                                </div>
                            </div>
                        </div>
