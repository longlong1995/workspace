            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">美容师管理</span>
                        <div class="description">修改删除医师</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="title">美容师信息</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="/admin/index/beauticianManager.html" method="post">
                                        <table class="datatable table table-striped" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" name="did[]" value="{$value.did}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="orderby[{$value.did}]" value="{$value.orderby}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="name[{$value.did}]" value="{$value.name}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="experience[{$value.did}]" value="{$value.experience}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="expert[{$value.did}]" value="{$value.expert}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="wechat[{$value.did}]" value="{$value.wechat}">
                                                    </td>
                                                    <td>{$value.sname}</td>
                                        ...
                                        <input type="submit" class="btn btn-default" name="delete" value="放入回收站">
                                        <input type="submit" class="btn btn-default" name="update" value="修改信息">
                                    </form>
                                </div>
                            </div>
                        </div>
