            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">查看并修改用户详情</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <form action="/admin/index/userInfo.html" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="sub-title">用户头像</div>
                                        <div>
                                            <img src="{$user_info.picture}" height="60">
                                        ...
                                        <div class="sub-title">注册时间</div>
                                        <div>
                                            <input type="text" class="form-control" name="create_time" value="{$user_info.create_time}" readonly />
                                        </div>

                                        <div class="sub-title">最近修改时间</div>
                                        <div>
                                            <input type="text" class="form-control" name="update_time" value="{$user_info.update_time}" readonly />
                                        </div>

                                        <div class="sub-title">最近登录时间</div>
                                        <div>
                                            <input type="text" class="form-control" name="last_time" value="{$user_info.last_time|date='Y-m-d H:i:s', ###}" readonly />
                                        </div>

                                        <div class="sub-title">注册IP</div>
                                        <div>
                                            <input type="text" class="form-control" name="ip" value="{$user_info.ip}" readonly />
                                        </div>

                                        <div class="sub-title">性别</div>
                                        <div>
                                            <div class="radio3 radio-check radio-inline">
                                                <input type="radio" id="radio4" name="sex" value="0" {if ($user_info.sex == '男')} checked="" {/if}>
                                                <label for="radio4">
                                                    男
                                                </label>
                                            </div>
                                            <div class="radio3 radio-check radio-success radio-inline">
                                                <input type="radio" id="radio5" name="sex" value="1" {if ($user_info.sex == '女')} checked="" {/if}>
                                                <label for="radio5">
                                                    女
                                                </label>
                                            </div>
                                            <div class="radio3 radio-check radio-warning radio-inline">
                                                <input type="radio" id="radio6" name="sex" value="2" {if ($user_info.sex == '保密')} checked="" {/if}>
                                                <label for="radio6">
                                                    保密
                                                </label>
                                            </div>
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="place" value="{$user_info.place}" />
                                        </div>
                                        
                                        <div class="sub-title"></div>
                                        <div>
                                            <input type="submit" name="dosubmit" class="btn btn-default" value="立即修改" />
                                        </div>
                                    </div>
                                </form>
                            </div>
