            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">修改和下架商品</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/admin/index/goodsManager.html" method="post">
                                        <table class="datatable table table-striped" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" name="gid[]" value="{$value.gid}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="gname[{$value.gid}]" value="{$value.gname}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="description[{$value.gid}]" value="{$value.description}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="current_price[{$value.gid}]" value="{$value.current_price}">
                                                    </td>
                                                    <td>
                                                       <input type="text" name="original_price[{$value.gid}]" value=" {$value.original_price}">
                                                    </td>
                                                    <td>
                                                        <select name="sort_id[{$value.gid}]">
                                                            {foreach ($sort_data as $v)}
                                                            <option value="{$v.id}" {if ($value.sort_id == $v.id)} selected {/if}>{$v.name}</option>
                                                            {/foreach}
                                                        </select>
                                                    </td>
                                        ...
                                        <input type="submit" name="delete" class="btn btn-default" value="下架">
                                        <input type="submit" name="update" class="btn btn-default" value="修改信息">
                                    </form>
                                </div>
                            </div>
                        </div>
