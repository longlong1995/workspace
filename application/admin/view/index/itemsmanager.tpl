                        ...
                        <div class="col-xs-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="title">美容项目信息</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="/admin/index/itemsManager.html" method="post">
                                        <table class="datatable table table-striped" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="bname[{$value.bid}]" value="{$value.bname}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="description[{$value.bid}]" value="{$value.description}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="deposit[{$value.bid}]" value="{$value.deposit}">
                                                    </td>
                                                    <td>
                                                       <input type="text" name="payment[{$value.bid}]" value=" {$value.payment}">
                                                    </td>
                                                    <td>
                                                        <select name="sort_id[{$value.bid}]">
                                                            {foreach ($sort_data as $v)}
                                                            <option value="{$v.sid}" {if ($value.sort_id == $v.sid)} selected {/if}>{$v.sname}</option>
                                                            {/foreach}
                                                        </select>
                                                    </td>
