            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">修改轮播不能为空</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <form action="/admin/index/carousel.html" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <p>选择你要上传的图片</p>
                                        <div class="sub-title">轮播图1</div>
                                        <div>
                                            <input type="file" name="carousel_picture1"  />
                                            <span>标题: </span><input type="text" name="carousel_title1" value="{$Think.const.CAROUSEL_TITLE1}">
                                            <span>描述: </span><input type="text" name="carousel_content1" value="{$Think.const.CAROUSEL_CONTENT1}">
                                            <img src="{$Think.const.CAROUSEL_PICTURE1}" height="100">
                                        </div>

                                        <div class="sub-title">轮播图2</div>
                                        <div>
                                            <input type="file" name="carousel_picture2"  />
                                            <span>标题: </span><input type="text" name="carousel_title2" value="{$Think.const.CAROUSEL_TITLE2}">
                                            <span>描述: </span><input type="text" name="carousel_content2" value="{$Think.const.CAROUSEL_CONTENT2}">
                                            <img src="{$Think.const.CAROUSEL_PICTURE2}" height="100">
                                        </div>

                                        <div class="sub-title">轮播图3</div>
                                        <div>
                                            <input type="file" name="carousel_picture3"  />
                                            <span>标题: </span><input type="text" name="carousel_title3" value="{$Think.const.CAROUSEL_TITLE3}">
                                            <span>描述: </span><input type="text" name="carousel_content3" value="{$Think.const.CAROUSEL_CONTENT3}">
                                            <img src="{$Think.const.CAROUSEL_PICTURE3}" height="100">
                                        </div>
