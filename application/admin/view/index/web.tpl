            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">修改信息不能为空</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <form action="/admin/index/web.html" method="post">
                                    <div class="card-body">
                                        <p>填写你需要改写的信息</p>
                                        <div class="sub-title">站点名称</div>
                                        <div>
                                            <input type="text" class="form-control" name="web_name" value="{$Think.const.WEB_NAME}" />
                                        </div>
                                        <div class="sub-title">网站名称</div>
                                        <div>
                                            <input type="text" class="form-control" name="web_btm" value="{$Think.const.WEB_BTM}" />
                                        </div>
                                        <div class="sub-title">网站URL</div>
                                        <div>
                                            <input type="text" class="form-control" name="web_url" value="{$Think.const.WEB_URL}" />
                                        </div>
                                        <div class="sub-title">网站备案信息代码</div>
                                        <div>
                                            <input type="text" class="form-control" name="web_icp" value="{$Think.const.WEB_ICP}" />
                                        </div>
                                        <div class="sub-title">关闭站点</div>
                                        <div>
                                            <div class="radio3 radio-check radio-inline">
                                                <input type="radio" id="radio1" name="web_close" value="true">
                                                <label for="radio1">
                                                    是
                                                </label>
                                            </div>
                                            <div class="radio3 radio-check radio-inline">
                                                <input type="radio" id="radio2" name="web_close" value="false" checked="">
                                                <label for="radio2">
                                                    否
                                                </label>
                                            </div>
