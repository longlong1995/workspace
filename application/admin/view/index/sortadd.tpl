            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">商品分类添加</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/admin/index/sortAdd.html" method="post" class="form-inline">
                                        <div class="form-group">
                                            <label for="exampleInputName2">显示顺序:</label>
                                            <input type="text" name="orderby" class="form-control" id="exampleInputName2" placeholder="1">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail2">分类名:</label>
                                            <input type="text" name="sname" class="form-control" id="exampleInputEmail2" placeholder="丰胸">
                                        </div>
