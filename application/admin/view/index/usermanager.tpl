            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">点击用户名查看详情</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/admin/index/userManager.html" method="post">
                                        <table class="datatable table table-striped" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/admin/index/userInfo.html?uid={$value.uid}">{$value.username}</a>
                                                    </td>
                                                    <td>{$value.usertype}</td>
                                                    <td>{$value.create_time}</td>
                                                    <td>{$value.last_time|date='Y-m-d H:i:s', ###}</td>
                                                    <td>
                                                        {if ($value.usertype == '管理员')}
                                                        <a href="/admin/index/userManager.html?uid={$value.uid}&t=0">取消管理员</a>
                                                        {else}
                                                         <a href="/admin/index/userManager.html?uid={$value.uid}&t=1">设为管理员</a>
                                                        {/if}
                                                        ||
                                                        {if ($value.allow_login == 0)}
                                                        <a href="/admin/index/userManager.html?uid={$value.uid}&l=1">锁定</a>
                                                        {else}
                                                        <a href="/admin/index/userManager.html?uid={$value.uid}&l=0">解锁</a>
                                                        {/if}
                                                    </td>
                                                </tr>
                                                {/foreach}
                                        ...
                                        <input type="submit" name="dosubmit" class="btn btn-default" value="放入回收站">
                                    </form>
                                </div>
                            </div>
                        </div>
