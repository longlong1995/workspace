            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">友情链接修改不能为空</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">删除或修改</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="/admin/index/link.html" method="post">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <input type="checkbox" name="lid[]" value="{$value.lid}">
                                                    </th>
                                                    <td>
                                                        <input type="text" name="orderby[{$value.lid}]" value="{$value.orderby}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="name[{$value.lid}]" value="{$value.name}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="url[{$value.lid}]" value="{$value.url}">
                                                    </td>
                                                    <td>
                                                        <img src="{$value.logo}" height="40">
                                                    </td>
                                                </tr>
                                                {/foreach}
                                                {/if}
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="submit" name="update" class="btn btn-default" value="修改">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="card-body">
                                    <form action="/admin/index/link.html" method="post" enctype="multipart/form-data">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th>显示顺序</th>
