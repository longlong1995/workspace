                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/admin/index/beauticianRecover.html" method="post">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="submit" class="btn btn-default" name="recover" value="恢复">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
