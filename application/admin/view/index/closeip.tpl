            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">禁止IP</span>
                        <div class="description">IP禁止不能登录</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">删除禁止IP</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="/admin/index/closeIp.html" method="post">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                        ...
                                        <input type="submit" name="delete" class="btn btn-default" value="删除">
                                        <div class="row">
                                            {$page}
                                        </div>
                                ...
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">添加禁止IP</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="/admin/index/closeIp.html" method="post" enctype="multipart/form-data">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th>禁止IP</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <input type="text" name="closeip1" maxlength="3" max="255" placeholder="000">
                                                        <span>-</span>
                                                        <input type="text" name="closeip2" maxlength="3" max="255" placeholder="000">
                                                        <span>-</span>
                                                        <input type="text" name="closeip3" maxlength="3" max="255" placeholder="000">
                                                        <span>-</span>
                                                        <input type="text" name="closeip4" maxlength="3" max="255" placeholder="000">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="day" value="30">
                                                        <span>天</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <input type="submit" name="add" class="btn btn-default" value="添加">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
