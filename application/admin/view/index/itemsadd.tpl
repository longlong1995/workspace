                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">填写美容项目信息</div>
                                    </div>
                                </div>
                                <form action="/admin/index/itemsAdd.html" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="sub-title">项目名称</div>
                                        <div>
                                            <input type="text" class="form-control" name="bname" placeholder="商品名">
                                        </div>
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="product_id" placeholder="项目编号">
                                        </div>
                                        <div class="sub-title">定金</div>
                                        <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                            <input type="text" name="deposit" placeholder="定金" class="form-control" aria-label="Amount (to the nearest dollar)">
                                        </div>
                                        
                                        <div class="sub-title">全额</div>
                                        <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                            <input type="text" name="payment" placeholder="全额" class="form-control" aria-label="Amount (to the nearest dollar)">
                                        </div>
                                        
                                        <div class="sub-title">项目图片</div>
                                        <div class="form-group">
                                            <input type="button" class="btn btn-default" value="项目大图">
                                            <li>
                                                <label for="exampleInputFile1">项目大图</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <ul>
                                                <li>
                                                    <label for="exampleInputFile2">项目详情-1</label>
                                                    <input type="file" name="detail_1" id="exampleInputFile2">
                                                    <p class="help-block">详情-1介绍</p>
                                                    <textarea name="description_1" class="form-control" rows="3"></textarea>
                                                </li>
                                                <li>
                                                    <label for="exampleInputFile3">项目详情-2</label>
                                                    <input type="file" name="detail_2" id="exampleInputFile3">
                                                    <p class="help-block">详情-2介绍</p>
                                                    <textarea name="description_2" class="form-control" rows="3"></textarea>
                                                </li>
                                                <li>
                                                    <label for="exampleInputFile4">项目详情-3</label>
                                                    <input type="file" name="detail_3" id="exampleInputFile4">
                                                    <p class="help-block">详情-3介绍</p>
                                                    <textarea name="description_3" class="form-control" rows="3"></textarea>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="sub-title">项目分类</div>
                                        <div>
                                            <select name="sort_id">
                                                {if (!empty($sort_data))}
                                        ...
                                        <div>
                                            <input type="submit" class="btn btn-default" value="添加美容项目">
                                        </div>
                                    </div>
                                </form>
                            </div>
