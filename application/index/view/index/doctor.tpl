                    ...
                    <div class="col-md-12">
                        <div class="page-title">
                            ...
                            <div class="page-content ">
                                <span>
                                    {if (empty(input('get.doctorid')))}全部{else}
                                        {foreach ($sort_info as $value)}
                                        {if ($value.sid == input('get.doctorid'))}
                                        {$value.sname}
                                        {/if}
                                        {/foreach}
                                    {/if}专家
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="sidebar">
                            ...
                            <div class="widget widget-categories style2">
                                <h4 class="widget-title">专家分类</h4>
                                <ul class="cotegories">
                                    {foreach ($sort_info as $value)}
                                    <li>
                                        <a href="doctor.html?doctorid={$value.sid}">{$value.sname}</a>
                                        <span>
											<?php $i = 0; ?>
                                            {foreach ($doctor_info as $v)}
                                                {if ($v.sid == $value.sid)}
                                                <?php $i++; ?>
                                                {/if}
                                            {/foreach}
                            ...
                            <div class="widget widget-product">
                                <h4 class="widget-title">专家排行榜(1-5)</h4>
                                <ul class="latest">
                                    {if (!empty($doctor_hot))}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="detail-product">
                                            <div class="item-img">
                                                <img src="{$value.picture}" alt="image" style="width: 100%;height: 80%;">
                                                <div class="overlay">
                                                    <a href="/index/index/doctor_details?did={$value.did}" class=""><i class="fa fa-search-plus"></i></a>
                                                </div>
                                            </div>
                                            <div class="wrap-content">
                                                <div class="item-content">
                                                    <h6 class="name"><a href="#">{$value.name}</a></h6>
                                                    <div class="racing-pri">
                                                        <div class="price-box"> 
                                                            <ins>
                                                                <span class="amount" style="overflow: hidden; text-overflow: ellipsis;white-space: nowrap;">{$value.expert}</span>
                                                            </ins>
                                                        </div>
                                                    </div>
                                                </div>
