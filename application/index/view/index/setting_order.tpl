                        ...
                        <div class="sidebar">
                            <div class="widget widget-nav-menu style2">
                                <ul class="widget-menu">
                                    ...
                                    <li   class="active"><a href="/index/index/setting_order">我的订单</a></li>
                                    ...
                                    <table class="table table-striped">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                                <form action="/index/index/setting_order" method="post">
                                                    <input type="hidden" name="oid" value="{$value.oid}">
                                                    <input type="submit" class="btn btn-default" name="delete" value="删除订单">
                                              </form>
                                          </td>
                                        </tr>
                                        {/foreach}
