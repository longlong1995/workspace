...
<head>
    ...
    <title>{$Think.const.WEB_NAME}个人中心</title>
                        ...
                        <div class="sidebar">
                            <div class="widget widget-nav-menu style2">
                                <ul class="widget-menu">
                                    ...
                                    <li   class="active"><a href="/index/index/setting_user">个人信息</a></li>
                                    <li><a href="/index/index/setting_order">我的订单</a></li>
                                    <li><a href="/index/index/setting_beautyorder">我的预约</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="post-wrap">
                            <article class="post clearfix">
                                <div class="featured-post">
                                 <form action="/index/index/setting_user" method="post">
                                  <div class="form-group">
                                    <label for="exampleInputEmail1">用户名</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" value="{$user.username}" name="username" readonly>
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleInputPassword1">真实姓名</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1" value="{$user.real_name}" name="real_name">
                                  </div>
                                 <div class="form-group">
                                    <label for="exampleInputPassword2">手机号</label>
                                    <input type="text" class="form-control" id="exampleInputPassword2" value="{$user.phone}" name="phone">
                                  </div>

                                  <div class="checkbox">
                                     <select name="sex">
                                          <option value="0" {if ($user.sex == '男')} selected="selected" {/if}>男</option>
                                          <option value="1" {if ($user.sex == '女')} selected="selected" {/if}>女</option>
                                          <option value="2" {if ($user.sex == '保密')} selected="selected" {/if}>保密</option>
                                     </select>
                                  </div>
