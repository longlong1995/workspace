                        ...
                        <div class="sidebar">
                            <div class="widget widget-nav-menu style2">
                                <ul class="widget-menu">
                                    <li class="active"><a href="/index/index/setting">修改头像</a></li>
                        ...
                        <div class="post-wrap">
                            <article class="post clearfix">
                                <div class="featured-post">
                                 <form action="/index/index/setting" method="post"  enctype="multipart/form-data">
                                     <div class="form-group">
                                        <div>
                                            <label for="exampleInputFile">用户头像</label>
                                             <img src="{$user.picture}" style="width: 80px; height: 80px;border-radius: 80px;">
                                        </div>
                                        <label for="exampleInputFile">上传新头像</label>
                                        <input type="file" id="exampleInputFile" name="picture">
                                        <p class="help-block">随心所欲想换就换</p>
                                      </div>
