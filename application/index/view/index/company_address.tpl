...
<head>
    ...
    <script type="text/javascript"
            src="https://webapi.amap.com/maps?v=1.4.1&key=ae0e19519fa5b2366f236db620a21d06"></script>
    <style type="text/css">
        #panel {
            position: absolute;
...
<body class="header-sticky">    
                ...
                <div class="row">
                        ...
                        <div class="sidebar">
                            <div class="widget widget-nav-menu style2">
                                <ul class="widget-menu">
                                    ...
                                    <li class="active"><a href="company_address.html">公司地址</a></li>
                    ...
                    <div class="col-md-9 col-sm-8">
                        <div class="page-content" style="height: 700px;">
                            <div id="mapContainer" style="width: 75%;height: " ></div>
                            <div id="panel"></div>
                        </div>
                    </div>
    ...
    AMap.service(["AMap.Transfer"], function() {
        ...
        //根据起、终点坐标查询公交换乘路线
        trans.search([{keyword:'郑州火车站'},{keyword:'河南教育学院(纬五路)'}], function(status, result){
        });
    });
</script>
