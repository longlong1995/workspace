...
<head>
    ...
    <title>{$Think.const.WEB_NAME}美容中心</title>
                    ...
                    <div class="col-md-12">
                        <div class="page-title">
                            ...
                            <div class="page-content ">
                                <span>
                                    {if (empty(input('get.centerid')))}全部{else}
                                        {foreach ($sort_info as $value)}
                                        {if ($value.sid == input('get.centerid'))}
                                        {$value.sname}
                                        {/if}
                                        {/foreach}
                                    {/if}项目
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="sidebar">
                            ...
                            <div class="widget widget-categories style2">
                                <h4 class="widget-title">项目分类</h4>
                                <ul class="cotegories">
                                    {foreach ($sort_info as $value)}
                                    <li>
                                        <a href="center.html?centerid={$value.sid}">{$value.sname}</a>
                                        <span>
											<?php $i = 0; ?>
                                            {foreach ($beauty_info as $v)}
                                                {if ($v.sort_id == $value.sid)}
                                                <?php $i++; ?>
                                                {/if}
                                            {/foreach}
                                            {$i}
                                    ...
                                    <div class="col-md-4">
                                        <div class="detail-product">
                                            <div class="item-img">
                                                ...
                                                <a href="/index/index/center_details?bid={$value.bid}">
                                                    <div class="overlay">
                                            ...
                                            <div class="wrap-content">
                                                ...
                                                <div class="wrap-button">
                                                    <form {if (!empty($user))} action="book.html" {else} action="/index/user/login.html" {/if} method="post">
                                                        <input type="hidden" name="bid" value="{$value.bid}">
                                                        <input type="hidden" name="sum" value="1">
                                                        <button class="flat-btn add-cart">立即预约</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
