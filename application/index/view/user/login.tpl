...
<head>
	...
	<link rel="stylesheet" href="/user/css/component.css"/>
	...
	<script src="/user/js/jquery.metadata.js"></script>
	<script src="/user/js/jquery.validate.message_cn.js"></script>
	<script src="/user/js/jquery.nicescroll.min.js"></script>
	<script src="/user/js/mgTextWidth.js"></script>
	<script src="/user/js/tinybox.js"></script>
    	<script src="/user/js/global.js"></script>
	<script src="/user/js/md5.js"></script>
	...
	<div id="login_main">
		...
		<div class="login_form">
			<div class="login_form_header">
				...
				<p class="p_register">
					<span class="img_register"></span>注册
				</p>
				<div class="clearB"></div>
			</div>
			<form action="/index/user/login.html" method="post" class="login_items" id="login_items">
				<input type="hidden" name="url" value="{$url}">
				<label class="input_val"><input class="input" name="username" id="login_nickname" autocomplete="off" placeholder="用户名" /><img src="/user/images/login_mail.png" /></label>
				<label class="input_val"><input class="input" name="password" type="password" id="login_password" autocomplete="off" placeholder="密码" /><img src="/user/images/login_password.png" /></label>
				<div class="login_msg">
					<p class="login_error">
						<span></span>
					</p>
				...
				<div class="clearB"></div>
				<input type="submit" name="login" class="login_btn submit" value="登&nbsp;&nbsp;&nbsp;&nbsp;录">
			</form>
			<form action="/index/user/register" method="post" class="register_items" id="register_items">
				
				<label class="input_val"><input class="input" id="username" name="username" value="" autocomplete="off" placeholder="用户名" /></label>
				<label class="input_val"><input class="input" id="phone" name="phone" value="" autocomplete="off" placeholder="手机号" /></label>
				<label class="input_val"><input class="input" name="code" style="width: 50%;" value="" autocomplete="off" placeholder="验证码" /><input type="button" style="width:36%;height: 37px;" class="register_btn" id="submit" value="发送验证码"></label>
				
				<label class="input_val"><input class="input" name="password" value="" type="password" autocomplete="off" placeholder="密码" /></label>
				<div class="remeber">
					点击注册表示您接受
				...
				<button class="login_btn submit">免&nbsp;&nbsp;费&nbsp;&nbsp;注&nbsp;&nbsp;册</button>
			</form>
			<div class="login_coopeField">
				<p class="coopeLogin_title" type="OPEN">使用其他账号登录</p>
				<div class="coopeLogin_mainFiild">
					<a class="btn_coopeLogin coopeLogin_qq" href="/qqlogin/example/oauth">
						<span class="span_coopeLogin">QQ快速登录</span>
					</a>
					<br />
					<br />
					<a class="btn_coopeLogin coopeLogin_weibo" href="https://api.weibo.com/oauth2/authorize?client_id=940227746&redirect_uri=http%3A%2F%2Fwww.cllscc.com%2Findex%2Fuser%2Fsina.html&response_type=code">
						<span class="span_coopeLogin">微博账号登录</span>
					</a>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	window.onload = function ()
	{
		...
		{
			if (oUsername.value == '' || oUsername.value.length < 6) {
				return false;
			}
	    	ajax({
				method: 'post',
		...
		oSub.onclick = function ()
		{
			...
			var url = '/index/user/phonecode';
			var xhr = new XMLHttpRequest();
			xhr.open('post',url,true);
			xhr.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
			var phoneNum='phone='+oPhone.value;
			xhr.send(phoneNum);
		}
