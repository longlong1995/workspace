...
$demo = new MsgDemo(
    ...
    "LTAIXlVAp4r0oGoJ", // 请替换成您自己的AccessKeyId
    "XRpjtqkz7URDssewBtSWXQgyJVbgsA" // 请替换成您自己的AccessKeySecret
);
...
$demo->receiveMsg(
    ...
    "Alicom-Queue-1803302434745823-SmsReport",
...
// string $messageType 消息类型: SmsReport | SmsUp
    ...
    // string $queueName 在云通信页面开通相应业务消息后，就能在页面上获得对应的queueName
    "Alicom-Queue-1803302434745823-SmsUp",
